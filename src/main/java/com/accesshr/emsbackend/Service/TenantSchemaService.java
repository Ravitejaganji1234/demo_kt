...
public class TenantSchemaService {
    ...
    public TenantSchemaService(DataSource dataSource, DataSourceConfig dataSourceConfig) {
    ...
    private void createTablesInSchema(String schemaName) {
        ...
        String dbUsername = dataSourceConfig.getDbUsername();
        String dbPassword = dataSourceConfig.getDbPassword();
